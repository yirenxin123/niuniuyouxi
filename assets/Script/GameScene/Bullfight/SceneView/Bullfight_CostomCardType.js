...
cc.Class({
    ...
    callBackBtnCard : function (event, CustonEventData) {
        ...
        if ((this.m_iCardValue.length >= 3) && card.cardSelected == 0){
            cc.log("Bullfight_CustomCardType.callBackBtnCard length=", this.m_iCardValue.length,
