...
JSCallOC.prototype.getDeviceName = function()
{
    ...
    {
        var name = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getDeviceName"
        );
...
JSCallOC.prototype.getAppVersionCode = function()
{
    if (cc.sys.isNative && this.checkIsAble())
    {
        var appVersion = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getAppVersionCode"
        );
...
JSCallOC.prototype.getOSVersion = function()
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        var OSVersion = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getOSVersion"
        );
...
JSCallOC.prototype.getAdapterType = function()
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        var adapterType = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getAdapterType"
        );
...
JSCallOC.prototype.getIOSVendor = function()
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        var IOSVendor = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getIOSVendor"
        );
...
JSCallOC.prototype.getIOSAdvertising = function()
{
    ...
    {
        var IOSAdvertising = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getIOSAdvertising"
        );
...
JSCallOC.prototype.getIOSMacAddress = function()
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        var IOSMacAddress = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getIOSMacAddress"
        );
...
JSCallOC.prototype.getIOSOpenUdid = function()
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        var IOSOpenUdid = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getIOSOpenUdid"
        );
...
JSCallOC.prototype.getUUID = function()
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        var UUID = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getUUID"
        );
...
JSCallOC.prototype.getAppName = function () {
    if(cc.sys.isNative && this.checkIsAble())
    {
        var appName = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "getAppName"
        );
...
JSCallOC.prototype.sendPayByWebView = function(payUrl,payData,showWeb)
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        jsb.reflection.callStaticMethod(
            "LocalInfo",
            "sendPayByWebView:payData:showWeb:",
            payUrl,
            payData,
            showWeb
        );
...
JSCallOC.prototype.sendIosPay = function(orderIdentifier,creatOrderUrl,mid,productid,mtkey,versions,gid,sid,money)
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        jsb.reflection.callStaticMethod(
            "LocalInfo",
            "payIosProduct:creatOrderUrl:mid:productid:mtkey:versions:gid:sid:money:",
            orderIdentifier,
            creatOrderUrl,
            mid,
            productid,
...
JSCallOC.prototype.DownloadRecordedFile = function(fileID,downloadFilePath)
{
	if(cc.sys.platform == cc.sys.ANDROID) {
		...
		if(cc.sys.isNative && this.checkIsAble())
		{
			jsb.reflection.callStaticMethod(
				"LocalInfo",
				"DownloadRecordedFile:downloadFilePath:",
				fileID,
				downloadFilePath
			);
		}
...
JSCallOC.prototype.screenShotAction = function()
{
    if(cc.sys.isNative && this.checkIsAble())
    {
        var path = jsb.reflection.callStaticMethod(
            "LocalInfo",
            "screenShotAction"
        );
